...
export const CreativeOrangeTemplate: React.FC<CreativeOrangeTemplateProps> = ({ 
  resume, 
  fontFamily = 'inter',
  ...
  const renderHeader = () => (
    <div className="bg-gradient-to-r from-orange-600 to-orange-800 text-white p-6 print:p-4 print:bg-orange-700 print:break-inside-avoid print:mb-4">
  ...
  const renderSummary = () => (
    resume.personalInfo.summary && (
      <section className="mb-6 print:mb-5 print:break-inside-avoid">
        <h3 className="text-xl print:text-lg font-semibold text-gray-800 mb-3 print:mb-2 border-b-2 border-orange-600 pb-1 print:break-after-avoid">
  ...
  const renderExperience = (stackDetails = false) => (
    resume.experiences.length > 0 && (
      <section className="mb-6 print:mb-5">
        <h3 className="text-xl print:text-lg font-semibold text-gray-800 mb-4 print:mb-3 border-b-2 border-orange-600 pb-1 print:break-after-avoid">
          Work Experience
        </h3>
            ...
            <div key={experience.id} className="print:break-inside-avoid print:mb-4">
              {stackDetails ? (
                ...
                <div className="mb-2 print:mb-1">
                  ...
                  <p className="text-orange-600 print:text-orange-700 font-medium break-words text-base print:text-xs">
                    {experience.company}
                  </p>
              ...
              {experience.technologies.length > 0 && (
                <div className="flex flex-wrap gap-1.5 print:gap-1">
                  {experience.technologies.map((tech, index) => (
                    <span
                      key={index}
                      className="px-2 py-1 print:px-1.5 print:py-0.5 bg-orange-100 print:bg-orange-50 text-orange-800 print:text-orange-900 text-xs print:text-[10px] rounded-md break-words"
                    >
                      {tech}
                    </span>
                  ))}
                    ...
                    <div className="flex flex-col gap-1 print:gap-0.5 text-sm print:text-[10px]">
                      {project.github && (
                        <div className="flex items-center gap-1">
                          ...
                          <a href={project.github} className="text-orange-600 print:text-orange-700 hover:text-orange-800 break-all" target="_blank" rel="noopener noreferrer">
                            {project.github}
                          </a>
                        </div>
                      )}
                      {project.demo && (
                        <div className="flex items-center gap-1">
                          ...
                          <a href={project.demo} className="text-orange-600 print:text-orange-700 hover:text-orange-800 break-all" target="_blank" rel="noopener noreferrer">
                            {project.demo}
                          </a>
                        </div>
                      )}
            ...
            <div key={index} className="print:break-inside-avoid">
              ...
              <div className="flex flex-wrap gap-1.5 print:gap-1">
                {skill.items.map((item, itemIndex) => (
                  <span
                    key={itemIndex}
                    className="px-2 py-1 print:px-1.5 print:py-0.5 bg-orange-100 print:bg-orange-50 text-orange-800 print:text-orange-900 text-sm print:text-xs rounded break-words"
                  >
                    {item}
                  </span>
                ))}
            ...
            <div key={edu.id} className="print:break-inside-avoid">
              {stackDetails ? (
                ...
                <div className="space-y-1 print:space-y-0.5">
                  ...
                  <p className="text-orange-600 print:text-orange-700 break-words text-sm print:text-xs">
                    {edu.institution}
                  </p>
                  {edu.location && (
