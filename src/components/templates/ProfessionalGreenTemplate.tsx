...
interface ProfessionalGreenTemplateProps {
  resume: Resume;
  fontFamily?: FontFamily;
}

export const ProfessionalGreenTemplate: React.FC<ProfessionalGreenTemplateProps> = ({ 
  resume, 
  fontFamily = 'inter' 
}) => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="bg-gradient-to-r from-emerald-600 to-emerald-800 text-white p-6 print:p-4 print:bg-emerald-700 print:break-inside-avoid print:mb-4">
      ...
      <div className="p-6 print:p-4 print:pt-0">
        ...
        {resume.personalInfo.summary && (
          <section className="mb-6 print:mb-5 print:break-inside-avoid">
            <h3 className="text-xl print:text-lg font-semibold text-gray-800 mb-3 print:mb-2 border-b-2 border-emerald-600 pb-1 print:break-after-avoid">
        ...
        {resume.experiences.length > 0 && (
          <section className="mb-6 print:mb-5">
            <h3 className="text-xl print:text-lg font-semibold text-gray-800 mb-4 print:mb-3 border-b-2 border-emerald-600 pb-1 print:break-after-avoid">
              Work Experience
            </h3>
                ...
                <div key={experience.id} className="print:break-inside-avoid print:mb-4">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 print:mb-1 gap-1 print:gap-0">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-emerald-600 print:text-emerald-700 font-medium break-words text-base print:text-xs">
                        {experience.company}
                      </p>
                    </div>
                  ...
                  {experience.technologies.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 print:gap-1">
                      {experience.technologies.map((tech, index) => (
                        <span
                          key={index}
                          className="px-2 py-1 print:px-1.5 print:py-0.5 bg-emerald-100 print:bg-emerald-50 text-emerald-800 print:text-emerald-900 text-xs print:text-[10px] rounded-md break-words"
                        >
                          {tech}
                        </span>
                      ))}
                    ...
                    <div className="flex flex-col gap-1 print:gap-0.5 flex-shrink-0 text-sm print:text-[10px]">
                      {project.github && (
                        <div className="flex items-center gap-1">
                          ...
                          <a href={project.github} className="text-emerald-600 print:text-emerald-700 hover:text-emerald-800 break-all" target="_blank" rel="noopener noreferrer">
                            {project.github}
                          </a>
                        </div>
                      )}
                      {project.demo && (
                        <div className="flex items-center gap-1">
                          ...
                          <a href={project.demo} className="text-emerald-600 print:text-emerald-700 hover:text-emerald-800 break-all" target="_blank" rel="noopener noreferrer">
                            {project.demo}
                          </a>
                        </div>
                      )}
                ...
                <div key={index} className="print:break-inside-avoid">
                  ...
                  <div className="flex flex-wrap gap-1.5 print:gap-1">
                    {skill.items.map((item, itemIndex) => (
                      <span
                        key={itemIndex}
                        className="px-2 py-1 print:px-1.5 print:py-0.5 bg-emerald-100 print:bg-emerald-50 text-emerald-800 print:text-emerald-900 text-sm print:text-xs rounded break-words"
                      >
                        {item}
                      </span>
                    ))}
              ...
              {resume.education.map((edu) => (
                <div key={edu.id} className="flex flex-col sm:flex-row sm:justify-between gap-2 print:gap-1 print:break-inside-avoid">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-emerald-600 print:text-emerald-700 break-words text-sm print:text-xs">
                      {edu.institution}
                    </p>
                    {edu.location && (
