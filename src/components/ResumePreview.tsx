...
export const ResumePreview: React.FC<ResumePreviewProps> = ({ resume }) => {
    return (
        <div className="bg-white shadow-lg max-w-4xl mx-auto min-h-screen print:shadow-none print:max-w-none print:mx-0">
            {/* Header */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 print:p-4 print:bg-blue-700 print:break-inside-avoid print:mb-4">
            ...
            <div className="p-6 print:p-4 print:pt-0">
                ...
                {resume.personalInfo.summary && (
                    <section className="mb-6 print:mb-5 print:break-inside-avoid">
                        <h3 className="text-xl print:text-lg font-semibold text-gray-800 mb-3 print:mb-2 border-b-2 border-blue-600 pb-1 print:break-after-avoid">
                                    ...
                                    {experience.technologies.length > 0 && (
                                        <div className="flex flex-wrap gap-1.5 print:gap-1">
                                            {experience.technologies.map((tech, index) => (
                                                <span
                                                    key={index}
                                                    className="px-2 py-1 print:px-1.5 print:py-0.5 bg-blue-100 print:bg-blue-50 text-blue-800 print:text-blue-900 text-xs print:text-[10px] rounded-md break-words"
                                                >
                                                    {tech}
                                                </span>
                                            ))}
                                        ...
                                        <div className="flex flex-col gap-1 print:gap-0.5 flex-shrink-0 text-sm print:text-[10px]">
                                            {project.github && (
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <a href={project.github} className="text-blue-600 print:text-blue-700 hover:text-blue-800 break-all" target="_blank" rel="noopener noreferrer">
                                                        {project.github}
                                                    </a>
                                                </div>
                                            )}
                                            {project.demo && (
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <a href={project.demo} className="text-blue-600 print:text-blue-700 hover:text-blue-800 break-all" target="_blank" rel="noopener noreferrer">
                                                        {project.demo}
                                                    </a>
                                                </div>
                                            )}
                                ...
                                <div key={index} className="print:break-inside-avoid">
                                    ...
                                    <div className="flex flex-wrap gap-1.5 print:gap-1">
                                        {skill.items.map((item, itemIndex) => (
                                            <span
                                                key={itemIndex}
                                                className="px-2 py-1 print:px-1.5 print:py-0.5 bg-blue-100 print:bg-blue-50 text-blue-800 print:text-blue-900 text-sm print:text-xs rounded break-words"
                                            >
                                                {item}
                                            </span>
                                        ))}
